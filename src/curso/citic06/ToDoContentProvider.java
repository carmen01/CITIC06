...
public class ToDoContentProvider extends ContentProvider {
  ...
  public static final Uri CONTENT_URI = 
      Uri.parse("content://curso.citic06/todoitems");
  ...
  static {
   ...
   uriMatcher.addURI("curso.citic06.todoprovider", "todoitems", ALLROWS);
   uriMatcher.addURI("curso.citic06.todoprovider", "todoitems/#", SINGLE_ROW);
  }
